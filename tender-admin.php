                ...
                if(in_array($pdf_ext, $extensions) == true) {// if the user uploaded file extensions matched with availabe extesion
                    ...
                    if(move_uploaded_file($tmp_name, "PDFs/".$new_pdf_name)){//if user upload pdf move to our folder successfully
                        ...
                        $sql2 = "INSERT INTO `grsetable` 
                                (`unitName`, `enquiryNum`, `enquiryDate`, `tenderDetails`, `status`, `closingDateTime`, `costOfTenderDoc`, `emd`, `pdfName`,`biddingInstruction`,`bidderPreQualification`) 
                                VALUES ('$unitName', '$enquiryNum', '$enquiryDate', '$tenderDetails', '$status', '$closingDateTime', '$costOfTenderDoc', '$emd', '$new_pdf_name', '$biddingInstruction', '$bidderPreQualification')";
        ...
        <form class="p-5" method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>" enctype="multipart/form-data">
            <fieldset>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="status" class="form-control bg-secondary" id="status" placeholder="Status">
                </div>
                <div class="form-group">
